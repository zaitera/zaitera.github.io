export const experience = {
    ...
    "items": [
        ...
        },
        {
            ...
            "description": "Resolved critical parallel parsing and rendering bottlenecks for electronic health records, cutting processing time by at least 50%. This was achieved by refactoring the application to leverage JavaScript promises and coordinating with the backend team to optimize pagination and API requests. Implemented FHIR standards using HAPI in a Spring Boot Kotlin environment.",

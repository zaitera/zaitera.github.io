...
import {ExternalLink, Folder, Github, Instagram, Linkedin, Mail, MapPin, Rss} from 'lucide-react';
                ...
                <div className="flex flex-col items-center text-center">
                    ...
                    <div className="mb-8 animate-float">
                        <div className="relative">
                            <div
                                className="w-80 h-80 bg-gradient-to-br from-primary/60 to-primary/80 rounded-2xl shadow-2xl transform rotate-3 opacity-20"></div>
                            <div
                                className="absolute inset-0 w-80 h-80 bg-gradient-to-tr from-accent/40 to-accent/60 rounded-2xl shadow-2xl transform -rotate-3 opacity-20"></div>
                            <div
                                className="absolute inset-0 w-80 h-80 bg-card rounded-2xl shadow-2xl border border-border overflow-hidden">
                                <img
                                    src={avatarImage}
                                    alt="Abdullah Zaiter"
                    ...
                    <div className="max-w-4xl animate-slide-up">
                        <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-foreground mb-6">
                          ...
                          {englishZaitech}
                                                    <ExternalLink
                                                        className={`h-4 w-4 ml-1 opacity-70 group-hover:opacity-100 group-hover:scale-110 transition-all duration-300 ${isRTL ? 'scale-x-[-1]' : ''}`}/>
                        </span>
                                                {parts[1]}
                                            </>
                                        );
                          ...
                          {arabicZaitech}
                                                    <ExternalLink
                                                        className={`h-4 w-4 opacity-70 group-hover:opacity-100 group-hover:scale-110 transition-all duration-300 ${isRTL ? 'mr-1 scale-x-[-1]' : 'ml-1'}`}/>
                        </span>
                                                {parts[1]}
                                            </>
                                        );

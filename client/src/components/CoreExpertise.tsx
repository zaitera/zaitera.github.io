            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="grid md:grid-cols-3 gap-8">
                    {expertiseData.items.map((item: ExpertiseItem) => {
                        ...
                        const IconComponent = (Icons[iconName as keyof typeof Icons] || Icons.Star) as React.ComponentType<{
                            className?: string
                        }>;
                        ...
                        return (
                            <Card key={item.id}
                                  className="bg-card hover:shadow-xl transition-shadow duration-300 border border-border">
                                <CardContent className="p-6">
                                    <div className="mb-4">
                                        <div
                                            className={`w-12 h-12 ${bgColorClass} rounded-lg flex items-center justify-center mb-4`}>
